...
public class ReportePruebas {
	...
	public void consultarProductosMenoresDeCien() {
		...
		Producto producto1 = new Producto(1, 2017, "producto comestible", 500, 0, 56, "gomitas", null);
		Producto producto2 = new Producto(1, 2017, "producto comestible", 1500, 0, 99, "panela", null);
		Producto producto3 = new Producto(1, 2017, "producto comestible", 3000, 0, 0, "arroz", null);
